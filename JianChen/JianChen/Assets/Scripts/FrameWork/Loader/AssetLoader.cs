...
namespace game.main
{
    ...
    public class AssetLoader
    {
        ...
        public static string GetConfigRulePate(string id)
        {
            string suffix = "RuleData/"+id+".json";
            return PathUtil.GetPath(suffix, ExternalHotfixPath);
        }
        
        public static string GetUserDataPath(string id)
        {
            string suffix = "UserData/"+id+".json";
            return PathUtil.GetPath(suffix, ExternalHotfixPath);
        }
        
        public static string GetMapDataPath(string id)
        {
            string suffix = "MapData/"+id+".json";
            return PathUtil.GetPath(suffix, ExternalHotfixPath);
        }

        public static string GetDialogDataPath(string id)
        {
            string suffix = "DialogData/" + id + ".json";
            return PathUtil.GetPath(suffix, ExternalHotfixPath);
        }
        ...
        {
            string suffix = PathUtil.PlatfromBundlePath() + "audio/bgmusic/" + id.ToLower() + ".music";
            return PathUtil.GetPath(suffix, ExternalHotfixPath);
        }

        public static string GetSoundEffectById(string id)
        {
            string suffix = PathUtil.PlatfromBundlePath() + "audio/effectclip/" + id.ToLower() + ".music";
            return PathUtil.GetPath(suffix, ExternalHotfixPath);
        }
        ...
        {
            string suffix = PathUtil.PlatfromBundlePath() + "audio/phonedialogs/" + id.ToLower() + ".music";
            return PathUtil.GetPath(suffix, ExternalHotfixPath);
        }
        ...
        public static void SaveUserData<T>(T saveobj,string dataName)
        {
            Debug.Log("save:"+dataName);
            string jsondata = JsonMapper.ToJson(saveobj);
            string path = GetUserDataPath(dataName);
        ...
        {
            if (filePath.Contains(AudioManager.DefaultBgMusicName.ToLower()) ||
                filePath.Contains(AudioManager.DefaultButtonEffectName.ToLower()))
                return;
        ...
        public static void UnloadAllAudio()
        {
            ...
            {
                if (bundle.Key.Contains(AudioManager.DefaultBgMusicName.ToLower()) ||
                    bundle.Key.Contains(AudioManager.DefaultButtonEffectName.ToLower()) ||
                    bundle.Key.Contains(AudioManager.DefaultBackButtonEffectName.ToLower()))
                    continue;
