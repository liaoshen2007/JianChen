...
public partial class UGUIScriptsCreate : Editor
{
    static private string m_scriptsPath = Application.dataPath + "/Scripts";//路径可以自定义
...
//    }
    ...
    [MenuItem("GameObject/UGUITools/AddUIType/UIText", priority = 0)]
    static void AddUIType_UIText()
    {
        AddUIType(UIType.Text);
    }
    ...
    [MenuItem("GameObject/UGUITools/CreateViewScripts", priority = 0)]
