...
//            if (!scene.enabled) continue;
    ...
    static void InitSetting()
    {
        ...
        Debug.Log("路径1=" + ApplicationPath);

        ApplicationPath = Application.dataPath.Replace("/JianChen/Assets", "");
        Debug.Log("路径2=" + ApplicationPath);
        ...
        AndroidBuildDir = ApplicationPath + "/AndroidBuildDanboard";
        ...
        PlayerSettings.productName = "JianChen";
    }
...
//            }
    ...
    [MenuItem("Build System/==Android Build==/Build Project Il2Cpp", false, 104)]
    public static void BuildForAndroidProjectIl2Cpp()
    {
        ScriptingImplementation = ScriptingImplementation.IL2CPP;
        doBuild();
    }
